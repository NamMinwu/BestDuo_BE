package com.bestduo_BE.consume.application;

import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.BDDMockito.given;
import static org.mockito.Mockito.verify;

import com.bestduo_BE.consume.application.port.BottomDuoRawSaver;
import com.bestduo_BE.consume.application.port.MatchSaver;
import com.bestduo_BE.consume.application.port.RiotMatchLoader;
import com.bestduo_BE.common.application.port.SummonerExpandQueue;
import com.bestduo_BE.common.domain.model.BottomDuoRaw;
import com.bestduo_BE.common.domain.model.CollectResult;
...
class CollectMatchDetailAndSaveRawTest {
  ...
  private CollectMatchDetailAndSaveRaw useCase;

  @BeforeEach
  void setUp() {
    useCase = new CollectMatchDetailAndSaveRaw(
        riotMatchLoader,
        matchSaver,
        bottomDuoRawSaver,
        summonerExpandQueue
  ...
  void saveMatchRawAndExpandParticipants() {
    ...
    CollectResult result = useCase.execute("KR_1", Tier.EMERALD);
